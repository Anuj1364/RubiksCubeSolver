//
// Created by anujp on 31-05-2024.
//
...
private:
    ...
    void rotateFace(int id)
    {
        ...
        for(int i=0 ; i<3 ; i++)
        {
            for(int j=0 ; j<3 ; j++)
            {
                temp_arr[i][j] = cube[id][i][j];
            }
        }

        for(int i=0 ; i<3 ; i++) cube[id][0][i] = temp_arr[2-i][0];
        for(int i=0 ; i<3 ; i++) cube[id][i][2] = temp_arr[0][i];
        for(int i=0 ; i<3 ; i++) cube[id][2][2-i] = temp_arr[i][2];
        for(int i=0 ; i<3 ; i++) cube[id][2-i][0] = temp_arr[2][2-i];
    }
